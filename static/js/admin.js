...
function(e) {
    ...
    C = {
        ...
        sendAuthCode: function(e) {
            ...
            n = function(s) {
                var l = a(e.elem);
                i--,
                i < 0 ? (l.removeClass(m).html("获取验证码"), i = e.seconds, clearInterval(t)) : l.addClass(m).html(i + "秒后重获"),
            ...
            function() {
                ...
                if (i === e.seconds && !a(this).hasClass(m)) {
                    if (!/^1\d{10}$/.test(s)) return t.focus(),
                    layer.msg("请输入正确的手机号");
        ...
        sideFlexible: function(e) {
            ...
            s = C.screen();
            console.log(123),
            "spread" === e ? (i.removeClass(b).addClass(v), s < 2 ? t.addClass(f) : t.removeClass(f), t.removeClass(g)) : (i.removeClass(v).addClass(b), s < 2 ? t.removeClass(g) : t.addClass(g), t.removeClass(f)),
        ...
        resize: function(e) {
            var a = layui.router(),
            t = a.path.join("-");
            o.off("resize", C.resizeFn[t]),
            e(),
            C.resizeFn[t] = e,
            o.on("resize", C.resizeFn[t])
        },
        resizeFn: {},
        runResize: function() {
            var e = layui.router(),
    ...
    A = C.events = {
        ...
        rollPage: function(e, t) {
            ...
            function() {
                ...
                if (o[0]) {
                    ...
                    if (e + o.outerWidth() >= s - l) {
                        ...
                        n.each(function(e, t) {
                            var n = a(t),
                            s = n.position().left;
                            if (s + l > 0 && s - l > r) return i.css("left", -s),
                            !1
                        })
                    }
                }
                ...
                var n = a(t),
                o = n.position().left;
                if (o + n.outerWidth() >= s - l) return i.css("left", -o),
                !1
            })
        },
        leftPage: function() {
    ...
    function() {
        ...
        C.tabsPage.index = t,
        "iframe" === e.attr("lay-attr") ? C.tabsBodyChange(t) : (P(e), void C.runResize())
    }),
